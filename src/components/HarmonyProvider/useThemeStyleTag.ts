...
import { HarmonyProviderProps } from "harmony-ui";
...
export const useThemeStyleTag = ({ theme }: Partial<HarmonyProviderProps>) => {
  ...
  // 唯一类名，css规则
  const themeClassName = "harmony-ui-HarmonyProvider" + escapedId;
  // 根据theme生成css规则
